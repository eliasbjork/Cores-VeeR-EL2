...
#(
    ...
    input logic exu_fpu_div_wren, // nonblocking fpu divide wirte enable to GPR.
    ...
    output logic dec_i0_rs3_en_d,  // rs3 enable at decode

    output logic [4:0] dec_i0_rs1_d,  // rs1 logical source
    output logic [4:0] dec_i0_rs2_d,  // rs2 logical source
    output logic [4:0] dec_i0_rs3_d,  // rs3 logical source (R4 ops)
    ...
    output logic [ 3:0] dec_i0_rs3_bypass_en_d,  // i0 rs3 bypass enable
    ...
    output el2_fpu_pkt_t       fpu_p,
    output logic        [4:0] fpu_div_waddr_wb,
    output logic              dec_fpu_div_cancel,
    ...
    output logic dec_fpu_div_active,
  ...
  logic [2:0] i0_rs1bypass, i0_rs2bypass, i0_rs3bypass;
  ...
  logic        fpu_decode_d;
  logic        fpu_div_decode_d;
  logic        fpu_div_e1_to_r;
  logic        fpu_div_flush;
  logic        fpu_div_active_in;
  logic        fpu_div_active;
  logic        i0_nonblock_fpu_div_stall;
  logic        i0_fpu_prior_fpu_div_stall;
  logic        nonblock_fpu_div_cancel;
  logic        mul_decode_d;
  logic        div_decode_d;
  logic        div_e1_to_r;
  logic        div_flush;
  ...
  logic [11:0] last_special_load_offset;
  ...
  logic i0_rs3_depend_i0_x, i0_rs3_depend_i0_r;

  logic i0_div_decode_d;
  logic i0_fpu_div_decode_d;
  logic i0_load_block_d;
  logic [1:0] i0_rs1_depth_d, i0_rs2_depth_d, i0_rs3_depth_d;
  ...
  el2_class_pkt_t i0_rs1_class_d, i0_rs2_class_d, i0_rs3_class_d;
  ...
  logic
      ...
      i0_rs3_nonblock_load_bypass_en_d;
  ...
  rvdffie #(9) misc2ff (
      ...
      .dout({
        lsu_trigger_match_r[3:0],
        lsu_pmu_misaligned_r,
        fpu_div_active,
        div_active,
        flush_final_r,
        debug_valid_x
...
`endif
  ...
  always_comb begin
    ...
    for (int i = 0; i < NBLOAD_SIZE; i++) begin
      ...
      i0_nonblock_load_stall |= dec_i0_rs3_en_d & cam[i].valid & (cam[i].rd[4:0] == i0r.rs3[4:0]);
    end
  ...
  assign i0_nonblock_boundary_stall = ((nonblock_load_rd[4:0]==i0r.rs1[4:0]) & lsu_nonblock_load_valid_m & dec_i0_rs1_en_d) |
                                       ...
                                       ((nonblock_load_rd[4:0]==i0r.rs3[4:0]) & lsu_nonblock_load_valid_m & dec_i0_rs3_en_d);
  ...
  rvdffe #(12) lsu_ofsett_ff (
      .*,
      .en  (i0_dp.load & i0_dp.special),
      .din (dec_lsu_offset_d[11:0]),
      .dout(last_special_load_offset[11:0])
  );
  ...
  assign fpu_p.fpu_div = i0_dp.fpu_div;
  assign fpu_p.fmadd = i0_dp.f_fmadd;
  assign fpu_p.fnmsub = i0_dp.f_fnmsub;
  assign fpu_p.add = i0_dp.f_add;
  assign fpu_p.mul = i0_dp.f_mul;
  assign fpu_p.div = i0_dp.f_div;
  assign fpu_p.sqrt = i0_dp.f_sqrt;
  assign fpu_p.sgnj = i0_dp.f_sgnj;
  assign fpu_p.minmax = i0_dp.f_minmax;
  assign fpu_p.cmp = i0_dp.f_cmp;
  assign fpu_p.classify = i0_dp.f_classify;
  assign fpu_p.f2f = i0_dp.f_f2f;
  assign fpu_p.f2i = i0_dp.f_f2i;
  assign fpu_p.i2f = i0_dp.f_i2f;
  ...
  assign fpu_p.cisc_op = i0_dp.special;
  ...
  assign dec_i0_rs3_en_d = i0_dp.rs3 & (i0r.rs3[4:0] != 5'd0);
  ...
  assign prior_inflight_eff = (i0_dp.div | i0_dp.fpu_div) ? prior_inflight_x : prior_inflight;

  assign i0_div_prior_div_stall = i0_dp.div & div_active;

  assign i0_fpu_prior_fpu_div_stall = (i0_dp.fpu | i0_dp.fpu_div) & fpu_div_active; //stall all fp-ops if fpu is performing a div
  ...
  assign i0_block_raw_d = (i0_dp.csr_read & prior_csr_write) |
                            ...
                            i0_nonblock_fpu_div_stall |
                            i0_fpu_prior_fpu_div_stall;
  ...
  assign fpu_decode_d = i0_exulegal_decode_d & i0_dp.fpu;
  ...
  assign i0_rs3_depend_i0_x = dec_i0_rs3_en_d & x_d.i0v & (x_d.i0rd[4:0] == i0r.rs3[4:0]);
  assign i0_rs3_depend_i0_r = dec_i0_rs3_en_d & r_d.i0v & (r_d.i0rd[4:0] == i0r.rs3[4:0]);
  ...
  assign {i0_rs3_class_d, i0_rs3_depth_d[1:0]} = (i0_rs3_depend_i0_x ) ? { i0_x_c,  2'd1  } :
                                                  (i0_rs3_depend_i0_r ) ? { i0_r_c,  2'd2  } : '0;
  ...
  if (pt.LOAD_TO_USE_PLUS1 == 1) begin : genblock
    ...
    assign store_data_bypass_m = i0_dp.store & i0_rs2_depth_d[0] & i0_rs2_class_d.load & ~i0_dp.fpu;
  ...
  assign i0_d_c.fpu  = i0_dp.fpu & i0_legal_decode_d & ~i0_dp.fpu_div;
  ...
  // mark FP op in dest class when fpu_p.valid (used to hold writes/forwarding if needed)
  assign d_d.i0fp          = i0_dp.fpu & i0_legal_decode_d;
  assign d_d.i0fpu_div      = i0_dp.fpu & i0_dp.fpu_div & i0_legal_decode_d;
  ...
  assign dec_i0_wen_r              =  i0_wen_r   & ~r_d_in.i0div & ~r_d_in.i0fpu_div & ~i0_load_kill_wen_r;  // don't write a nonblock load 1st time down the pipe
  ...
  assign i0_nonblock_div_stall  = (dec_i0_rs1_en_d & div_active & (div_waddr_wb[4:0] == i0r.rs1[4:0])) |
                                   ...
                                   (dec_i0_rs3_en_d & div_active & (div_waddr_wb[4:0] == i0r.rs3[4:0]));
  ...
  //fpu divide
  assign fpu_div_e1_to_r = (x_d.i0fpu_div & x_d.i0valid) | (r_d.i0fpu_div & r_d.i0valid);

  assign fpu_div_active_in = i0_fpu_div_decode_d | (fpu_div_active & ~exu_fpu_div_wren & ~nonblock_fpu_div_cancel);


  assign dec_fpu_div_active = fpu_div_active;

  // nonblocking div scheme

  assign i0_nonblock_fpu_div_stall  = (dec_i0_rs1_en_d & fpu_div_active & (fpu_div_waddr_wb[4:0] == i0r.rs1[4:0])) |
                                      (dec_i0_rs2_en_d & fpu_div_active & (fpu_div_waddr_wb[4:0] == i0r.rs2[4:0])) |
                                      (dec_i0_rs3_en_d & fpu_div_active & (fpu_div_waddr_wb[4:0] == i0r.rs3[4:0]));


  assign fpu_div_flush              = (x_d.i0fpu_div & x_d.i0valid & (x_d.i0rd[4:0]==5'b0)                           ) |
                                      (x_d.i0fpu_div & x_d.i0valid & dec_tlu_flush_lower_r                           ) |
                                      (r_d.i0fpu_div & r_d.i0valid & dec_tlu_flush_lower_r & dec_tlu_i0_kill_writeb_r);


  // cancel if any younger inst committing this cycle to same dest as nonblock divide
  assign nonblock_fpu_div_cancel    = (fpu_div_active &  fpu_div_flush) |
                                      (fpu_div_active & ~fpu_div_e1_to_r & (r_d.i0rd[4:0] == fpu_div_waddr_wb[4:0]) & i0_wen_r);

  assign dec_fpu_div_cancel = nonblock_fpu_div_cancel;

  assign i0_fpu_div_decode_d = i0_legal_decode_d & i0_dp.fpu_div;
  ...
  assign i0_rs3_nonblock_load_bypass_en_d  = dec_i0_rs3_en_d & dec_nonblock_load_wen & (dec_nonblock_load_waddr[4:0] == i0r.rs3[4:0]);

  // bit 2 is priority match, bit 0 lowest priority, i0_x, i0_r

  assign i0_rs1bypass[2]                =  i0_rs1_depth_d[0] & (i0_rs1_class_d.alu | i0_rs1_class_d.mul | i0_rs1_class_d.fpu                       );
  assign i0_rs1bypass[1] = i0_rs1_depth_d[0] & (i0_rs1_class_d.load);
  assign i0_rs1bypass[0]                =  i0_rs1_depth_d[1] & (i0_rs1_class_d.alu | i0_rs1_class_d.mul | i0_rs1_class_d.fpu | i0_rs1_class_d.load);

  assign i0_rs2bypass[2]                =  i0_rs2_depth_d[0] & (i0_rs2_class_d.alu | i0_rs2_class_d.mul | i0_rs2_class_d.fpu                      );
  assign i0_rs2bypass[1] = i0_rs2_depth_d[0] & (i0_rs2_class_d.load);
  assign i0_rs2bypass[0]                =  i0_rs2_depth_d[1] & (i0_rs2_class_d.alu | i0_rs2_class_d.mul | i0_rs2_class_d.fpu | i0_rs2_class_d.load);

  assign i0_rs3bypass[2]                =  i0_rs3_depth_d[0] & (i0_rs3_class_d.alu | i0_rs3_class_d.mul | i0_rs3_class_d.fpu                      );
  assign i0_rs3bypass[1] = i0_rs3_depth_d[0] & (i0_rs3_class_d.load);
  assign i0_rs3bypass[0]                =  i0_rs3_depth_d[1] & (i0_rs3_class_d.alu | i0_rs3_class_d.mul | i0_rs3_class_d.fpu | i0_rs3_class_d.load);
  ...
  assign dec_i0_rs3_bypass_en_d[3]      =  i0_rs3_nonblock_load_bypass_en_d & ~i0_rs3bypass[0] & ~i0_rs3bypass[1] & ~i0_rs3bypass[2];
